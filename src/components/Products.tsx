...
const blocks = [
  {
    ...
    desc: "Distribution en gros de casiers de boissons SOBEBRA. Bouteilles consignées, casiers complets, palettes entières, camions livrés directement chez vous.",
    img: beer,
  ...
  },
  {
    ...
    desc: "Vente en gros et détail de packs de boissons SOBEBRA en bouteilles PET. Packs disponibles pour tous formats.",
    img: water,
